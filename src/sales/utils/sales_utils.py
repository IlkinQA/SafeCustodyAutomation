...
if __name__ == '__main__':
    sales_api = SalesAPI()
    res = sales_api.sale_list(start_date='2024-11-26', end_date='2025-02-26', page_size=20, page_number=1, organizationId=46307, sales_grouping=1, detail_groups=562)
    print(SalesUtils.check_detail_group_id(res, 222))